...
@include( dirname( __FILE__ ) . '/lib/vendor/symfony/lib/action/sfActionStack.class.php' );
...
check(class_exists('HTTP_Download'), 'PEAR HTTP_Download is Installed', 'Please install HTTP_Download before trying to use the application', true);
check(class_exists('sfActionStack'), 'Symfony is Installed', 'Symfony is missing or has been placed in the wrong folder!', true);
